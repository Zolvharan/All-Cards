...
public class CharacterData
{
    ...
    public void ConstructCharacter(CharacterStats basePrefab, List<Item> newItems)
    {
        ...
        baseStats["precision"] = stats[3];
        baseStats["defense"] = stats[4];
        baseStats["dexterity"] = stats[5];
        baseStats["resistance"] = stats[6];
        baseStats["energyRegen"] = stats[7];
        ...
        {
            newAbilities[i] = abilities[i].ConstructAbility();
        }

        basePrefab.ConstructCharacter(characterName, newAbilities, newPortrait, newBattleSprite, flying, baseStats, newItems);
    }
