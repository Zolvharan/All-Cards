...
public class MCManager : MonoBehaviour
{
    ...
    public void SaveCharacter()
    {
        ...
        else
        {
            ...
            mainManager.DisplaySavedCharacterData(newCharacter, editing ? ccManager.lists[0].value : -1);
        }
    }

    // Sets portrait or battleSprite
    public void SetImage(Sprite newImage, byte[] newData, bool isPortrait)
    {
        if (isPortrait)
        {
